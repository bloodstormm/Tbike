  ...
  return (
    <div className="p-4 text-black font-sans container mx-auto">
      ...
      <Image
        ...
        width={400}
        height={400}
        className="mx-auto w-full mt-12 md:w-1/2 lg:w-1/3"
      />
      ...
      <div className="flex flex-col justify-between mt-8 w-full items-center">
        <div className="md:w-2/3">
          ...
          <p className="font-bold text-3xl text-[#346A90]">
            R$ {bike.valorHora}/h
          </p>
          <p className="my-4">
            Essa é uma bicicleta de design futurista, moldada para a velocidade
            e o conforto. Com um quadro de fibra de carbono leve e aerodinâmico,
            pintado em um tom metálico de cinza escuro com detalhes em azul
            elétrico, ela reflete o equilíbrio perfeito entre elegância e
            performance. As rodas são finas, de aro 29, projetadas com
            tecnologia anti-impacto para suavizar os terrenos mais desafiadores,
            enquanto os pneus sem câmara garantem uma tração excelente e uma
            experiência de pedalada suave.
          </p>
        </div>
